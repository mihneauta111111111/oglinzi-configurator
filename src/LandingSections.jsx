...
const SPECS = [
  ...
  { label: 'Lumina LED', value: '4 culori', note: 'Cald, rece, roz sau mov - direct la priza.' },
...
const FAQ = [
  ...
  { q: 'Ce culori de LED sunt disponibile?', a: 'Alb cald, alb rece, roz si mov. Banda LED se aprinde direct in priza si lumineaza conturul oglinzii.' },
