...
const SPECS = [
  ...
  { label: 'Lumina LED', value: '5 culori', note: 'Cald, RGB, rosu, albastru sau UV - direct la priza.' },
...
const FAQ = [
  ...
  { q: 'Ce culori de LED sunt disponibile?', a: 'Alb cald, RGB cu telecomanda (+30 RON), rosu, albastru sau UV light. Poti alege si varianta fara iluminare. Banda LED se aprinde direct in priza si lumineaza conturul oglinzii.' },
